...
build: $(SDIR)/progetto.c $(SDIR)/progetto.h $(SDIR)/units.c $(SDIR)/tens.c
	@mkdir build && gcc $(SDIR)/progetto.c $(SDIR)/progetto.h -o countdown && gcc $(SDIR)/tens.c -o tens && gcc $(SDIR)/units.c -o units && gcc $(SDIR)/counttest.c -o counttest &&  mv countdown  build/ && mv tens build/ && mv units build/ && mv counttest build/
